...
public class ClusterInterface2 {
   ...
   public Map<Float, List<Cluster>> clusterData(String ontologyFile, String selectedData,
      ...
      boolean useOHClust = ontologyFile != null;

      if (useOHClust) {
         System.out.println("I *AM* using OHClust!");
         clusterOnt = Ontology.createOntology(new File(ontologyFile));
         System.out.println("getting isolate meta data...");
         mConn.getIsolateMetaData(isolateDataList, clusterOnt, isolateDataList.size());
         System.out.println("finished getting isolate meta data!");
      }
