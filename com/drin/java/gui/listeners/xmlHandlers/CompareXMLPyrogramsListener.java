package com.drin.java.gui.listeners.xmlHandlers;

import com.drin.java.gui.MainWindow;

import com.drin.javadataParser.Polyparse;
import com.drin.javadataParser.SequenceParser;

import com.drin.javaPyrogramComparer;
...
public class CompareXMLPyrogramsListener implements java.awt.event.ActionListener {
	//will have to do later when imports can be fixed
   ...
   private final String PERM_STR = "(ATCG)"; 
   private String[] basicPermutations = new String[] { 
   ...
   */
	...
	public void actionPerformed(java.awt.event.ActionEvent e) {
      ...
      //Files (XML format) to compare
      JLabel firstLabel = new JLabel("Data (XML) Directory:");
      ...
      distanceOptions = new JComboBox(new String[] {
            "Pearson Correlation", "Euclidean Distance", "Equality", "Direct Comparison"
      });
      ...
      okayButton.addActionListener(new ActionListener(){
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            //ArrayList<String> candidateSequences = new ArrayList<String>();
            ...
            for (int strNdx = 0; strNdx < dispOrderList.length; strNdx++) {
               ...
               if (dispOrderList[strNdx].contains(PERM_STR)) {
                  for (int permNdx = 0; permNdx < basicPermutations.length;
                   permNdx++) {
                     String tmpStr = dispOrderList[strNdx];
                     candidateSequences.add(
                      tmpStr.replace(PERM_STR, basicPermutations[permNdx]));
                  }
               }
               else {
                  System.out.println("size: " + candidateSequences.size());
                  candidateSequences.add(strNdx, readSequences[strNdx]);
               }
               */
            }
            ...
            */
            ...
            if (comparisonOptions.getSelectedItem().equals("Forward")) {
               System.out.println("comparing forward sequences...");
               comparisonResults = pyrogramComparer.compareForwardSequences(true);
               System.out.println("finished comparing forward sequences.");
            }
            else {
