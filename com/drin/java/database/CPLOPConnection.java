...
public class CPLOPConnection {
   ...
   private static final String DB_URL = "jdbc:mysql://localhost?autoReconnect=true";
   private static final String DB_INFO_URL = "jdbc:mysql://localhost?autoReconnect=true";
